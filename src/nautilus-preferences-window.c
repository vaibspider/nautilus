                                           ...
                                           gpointer     user_data)
{
    ...
    for (i = 0; icon_captions_components[i] != NULL; i++)
    {
        ...
        combo_box = GTK_WIDGET (gtk_builder_get_object (builder, icon_captions_components[i]));
                                     ...
                                     const char *name)
{
    ...
    g_signal_handlers_block_by_func (combo_box, G_CALLBACK (icon_captions_changed_callback), builder);
    ...
    g_signal_handlers_unblock_by_func (combo_box, G_CALLBACK (icon_captions_changed_callback), builder);
}
...
nautilus_preferences_window_setup_icon_caption_page(GtkBuilder *builder)
{
    ...
    for (i = 0; icon_captions_components[i] != NULL; i++)
    {
        ...
        g_signal_connect_data (combo_box, "changed", G_CALLBACK (icon_captions_changed_callback),
                                   ...
                                   int            n_values)
{
    ...
    g_settings_bind_with_mapping (settings, prefs, gtk_builder_get_object (builder, widget_name), "active",
...
static void set_gtk_filechooser_sort_first(GObject    *object,
                                           GParamSpec *pspec)
{
    g_settings_set_boolean (gtk_filechooser_preferences, NAUTILUS_PREFERENCES_SORT_DIRECTORIES_FIRST,
                                              ...
                                              GtkWindow  *parent_window)
{
    ...
    bind_builder_radio (builder, nautilus_preferences, (const char **)click_behavior_components,
...
void nautilus_preferences_window_show(GtkWindow *window)
{
    ...
    gtk_builder_add_from_resource (builder, "/org/gnome/nautilus/ui/nautilus-preferences-window.ui", NULL);
