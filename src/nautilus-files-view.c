                                      ...
                                      NautilusDirectory *directory)
{
    ...
    view->details->subdirectory_list = g_list_prepend (view->details->subdirectory_list, directory);
}
                                         ...
                                         NautilusDirectory *directory)
{
    ...
    view->details->subdirectory_list = g_list_remove (view->details->subdirectory_list, directory);
                                     ...
                                     int                y)
{
    ...
    if (target_file != NULL && nautilus_file_is_launcher (target_file))
    {
        ...
        nautilus_launch_desktop_file (gtk_widget_get_screen (GTK_WIDGET (view)),
